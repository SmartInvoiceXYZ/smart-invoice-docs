...
export async function getStaticPaths() {
    const files = fs.readdirSync(path.join('docs-v3', 'arbitration-policies'))
...
export async function getStaticProps({ params }) {
    ...
    const markdown = fs.readFileSync(path.join('docs-v3', 'arbitration-policies', params.slug + '.md'), 'utf-8')
