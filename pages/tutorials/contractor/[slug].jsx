...
export async function getStaticPaths() {
  const files = fs.readdirSync(path.join('docs-v2', 'tutorials', 'contractor'))
...
export async function getStaticProps({ params }) {
  ...
  const markdown = fs.readFileSync(path.join('docs-v2', 'tutorials', 'contractor', params.slug + '.md'), 'utf-8')
